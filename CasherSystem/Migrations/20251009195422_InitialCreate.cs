        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecretNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Barcode", "Color", "CostPrice", "Name", "Quantity", "SellPrice", "Size" },
                values: new object[,]
                {
                    { 1, "TSH001", "Blue", 15.00m, "Cotton T-Shirt", 50, 25.00m, "M" },
                    { 2, "JEA001", "Blue", 35.00m, "Denim Jeans", 30, 60.00m, "L" },
                    { 3, "HOO001", "Black", 40.00m, "Hoodie", 20, 75.00m, "XL" },
                    { 4, "DRE001", "Red", 25.00m, "Summer Dress", 15, 45.00m, "S" },
                    { 5, "SNE001", "White", 50.00m, "Sneakers", 25, 90.00m, "42" }
                });
